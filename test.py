...
def main():
    ...
    print(admin.view_all(cursor2))
    print(admin.get_role(cursor2, 'james2@southwestern.edu'))
    print(admin.get_role(cursor2, 'trustrthyuser@southwestern.edu'))
    print(admin.get_role(cursor2, 'fakeemail@hotmail.com'))
    #save(connection2)
    cursor2.close()
    connection2.close()
